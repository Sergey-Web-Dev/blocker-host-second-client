...
export interface DeleteUserBodyDto {
  email: string;
}
...
export const authControllerDeleteUser = (
  deleteUserBodyDto: BodyType<DeleteUserBodyDto>,
  options?: SecondParameter<typeof createInstance>
) => {
  return createInstance<void>(
    {
...
>;
export type AuthControllerDeleteUserResult = NonNullable<
